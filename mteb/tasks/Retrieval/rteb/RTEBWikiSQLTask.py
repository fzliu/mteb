...
# --- WikiSQL Specific Task ---
_WIKISQL_TASK_NAME = "RTEBWikiSQL"
_WIKISQL_DESCRIPTION = "RTEB evaluation for WikiSQL dataset."
# Use the user-provided path
_WIKISQL_DATA_PATH = "/Users/fodizoltan/Projects/toptal/voyageai/ebr-frank/data"
_WIKISQL_DATASET_NAME = "WikiSQL"
_WIKISQL_METADATA = TaskMetadata(
    name=_WIKISQL_TASK_NAME,
    description=_WIKISQL_DESCRIPTION,
...
class RTEBWikiSQL(AbsTaskRetrieval):  # Inherit directly from MTEB's AbsTaskRetrieval
    metadata = _WIKISQL_METADATA
    # Define RTEB specific paths as class attributes
    rteb_data_path = _WIKISQL_DATA_PATH
    rteb_dataset_name = _WIKISQL_DATASET_NAME
